...
#define SPI_DEVICE_CNT 3       // 达妙开发板引出三路spi,分别连接BMI088/WS2812/作为扩展IO在16pin排母引出
 ...
 * @param len 接收&发送的长度
 */
void SPITransRecv(SPIInstance *spi_ins, uint8_t *ptr_data_rx, const uint8_t *ptr_data_tx, uint8_t len);
